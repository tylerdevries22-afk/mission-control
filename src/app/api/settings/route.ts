...
const settingDefinitions: Record<string, { category: string; description: string; default: string }> = {
  ...
  'general.mac_cleanup_watch': { category: 'general', description: 'Trigger safe Mac cache cleanup when disk is below the emergency threshold and npm/pnpm are idle', default: 'true' },
